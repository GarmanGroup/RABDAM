function [dataArray] = parseBdamage(BdamageFile)

%% Read in the Bdamage file

bdamageFile = fileread(BdamageFile);
...
for eachRow = 1:length(startIndexOfATOMbdamageInfo)
    atomBdamInfo = bdamageFile(startIndexOfATOMbdamageInfo(eachRow) : startIndexOfATOMbdamageInfo(eachRow)+125);
    ...
    dataArray{eachRow,16} = atomBdamInfo(81:86);
    dataArray{eachRow,17} = atomBdamInfo(87:93);
    dataArray{eachRow,18} = atomBdamInfo(95:98);
    dataArray{eachRow,19} = atomBdamInfo(100:102);
    dataArray{eachRow,20} = atomBdamInfo(108:122);
    dataArray{eachRow,21} = atomBdamInfo(124:126);
...
for eachRow = 1:length(startIndexOfHETATMbdamageInfo)
    atomBdamInfo = bdamageFile(startIndexOfHETATMbdamageInfo(eachRow) : startIndexOfHETATMbdamageInfo(eachRow)+125);
    ...
    dataArray{eachRow + numberOfAtoms,16} = atomBdamInfo(81:86);
    dataArray{eachRow + numberOfAtoms,17} = atomBdamInfo(87:93);
    dataArray{eachRow + numberOfAtoms,18} = atomBdamInfo(95:98);
    dataArray{eachRow + numberOfAtoms,19} = atomBdamInfo(100:102);
    dataArray{eachRow + numberOfAtoms,20} = atomBdamInfo(108:122);
    dataArray{eachRow + numberOfAtoms,21} = atomBdamInfo(124:126);
    tableOfInfo = sprintf('%s%s\n',tableOfInfo,atomBdamInfo(1:end-1));
end
