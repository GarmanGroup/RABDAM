...
def rabdam_dataframe(pathToPDB, PDT=14, windowSize=0.02,
    ...
    print 'Processing PDB file with PDBCUR\n'
    ...
    # list of all atoms in the unit cell. The unit cell PDB file is then
    # deleted unless createUCpdb is set equal to True in INPUT.txt.
...
def rabdam_analysis(pathToPDB, threshold=0.02, highlightAtoms=[],
    ...
    potential_analysis_files = [
                 ...
                 'Bdamage.png', '_above_boundary.pdb'
                 ]
