...
cambda(pathToPDB, PDT=pdtVal, binSize=binVal, addAtoms=addAtomsList, removeAtoms=removeAtomsList, threshold=thresholdVal, createAUCpdb=aucVal, createTApdb=taVal)
